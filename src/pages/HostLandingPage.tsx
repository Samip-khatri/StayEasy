...
function HostLandingPage() {
  ...
  return (
    ...
    >
      {/* HERO */}
      <section className="bg-primary text-white overflow-hidden pt-16 pb-0 relative">
        <button
          onClick={() => navigate('/')}
        ...
        <div className="max-w-[1180px] mx-auto px-8">
          <div className="grid grid-cols-[1.1fr_0.9fr] gap-10 items-center max-lg:grid-cols-1">
            <div>
              <span className="text-xs tracking-[0.08em] uppercase text-white/70 font-semibold mb-5 flex items-center gap-2.5">
                <span className="w-[7px] h-[7px] bg-white/70 rounded-full inline-block"></span>
                Hosting · Open enrollment
              </span>
              <h1 className="text-white text-[clamp(40px,6vw,68px)] leading-[1.05] font-bold tracking-tight mb-5">
                Your place,<br /><em className="italic text-[#FFB088] not-italic">your terms</em>,<br />zero cut.
              </h1>
              ...
              <div className="flex items-center gap-5 flex-wrap">
                <button
                  ...
                  className="bg-white hover:bg-gray-100 text-primary px-8 py-4 rounded-full font-semibold text-[15px] border-none cursor-pointer inline-flex items-center gap-2.5 transition-all duration-200 hover:-translate-y-0.5"
                >
           ...
           <div className="relative flex items-center justify-center min-h-[380px]">
              <div className="bg-white text-charcoal w-[300px] rounded-[4px] rotate-[4deg] shadow-[0_30px_60px_-20px_rgba(28,27,25,0.45)] relative z-10 max-lg:rotate-0">
                ...
                >
                  ...
                  ></div>
                  <span className="absolute top-3.5 left-3.5 bg-black/40 text-white text-[11px] px-2.5 py-1 rounded-[3px] uppercase tracking-[0.08em] font-semibold backdrop-blur-sm">
                    Live listing
                  </span>
                </div>
                <div className="p-[18px_20px_22px]">
                  ...
                  <div className="flex justify-between items-baseline border-t border-gray-100 pt-3.5">
                    ...
                    <span className="text-[11px] uppercase tracking-[0.08em] text-primary font-semibold">You keep 100%</span>
                  </div>
                </div>
              </div>
      ...
      <section className="py-36 bg-gradient-to-b from-white via-blue-50/30 to-white relative">
        <div className="max-w-[1180px] mx-auto px-8">
          <div className="max-w-[700px] mx-auto text-center mb-16">
            <span className="text-sm uppercase tracking-[0.08em] text-primary font-semibold mb-4 block relative inline-flex items-center gap-4 before:block before:w-8 before:h-px before:bg-primary/30 after:block after:w-8 after:h-px after:bg-primary/30">Why host here</span>
          ...
          <div className="grid grid-cols-3 gap-6 max-lg:grid-cols-1 max-lg:max-w-lg max-lg:mx-auto">
            {[
              ...
              <div key={item.num} className="bg-white rounded-xl px-10 py-12 border border-gray-200/60 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                <div className="font-mono text-sm text-primary font-bold mb-6">{item.num}</div>
      ...
      <section className="bg-white py-24">
        <div className="max-w-[1180px] mx-auto px-8">
          <div className="max-w-[560px] mb-14">
            <span className="text-xs uppercase tracking-[0.08em] text-primary font-semibold mb-3.5 block">Before you list</span>
            ...
            {faqData.map((item, i) => (
              <div key={i} className="border-b border-gray-200">
                ...
                >
                  ...
                  <span className={`font-mono text-lg text-primary shrink-0 transition-transform duration-250 ${openFaq === i ? 'rotate-45' : ''}`}>+</span>
                </div>
      ...
      <section className="mx-8 mb-24 max-sm:mx-5 max-sm:mb-[70px]">
        <div className="bg-primary text-white rounded-md py-[70px] px-[60px] relative overflow-hidden max-sm:py-12 max-sm:px-7">
